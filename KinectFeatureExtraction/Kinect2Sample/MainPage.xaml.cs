...
namespace Kinect2Sample
{
    ...
    public sealed partial class MainPage : Page, INotifyPropertyChanged
    {
        ...
        private ushort shortestDistance = 0;
        private ushort longestDistance = 0;
        ...
        public ushort ShortestDistance
        {
            get { return this.shortestDistance; }
            set
            {
                if (this.shortestDistance != value)
                {
                    this.shortestDistance = value;
                    if (this.PropertyChanged != null)
                    {
                        this.PropertyChanged(this, new PropertyChangedEventArgs("ShortestDistance"));
                    }
                }
            }
        }

        public ushort LongestDistance
        {
            get { return this.longestDistance; }
            set
            {
                if (this.longestDistance != value)
                {
                    this.longestDistance = value;
                    if (this.PropertyChanged != null)
                    {
                        this.PropertyChanged(this, new PropertyChangedEventArgs("LongestDistance"));
                    }
                }
            }
        }
